...
def run_goat_tournament_v4():
    print("=== BOREAL GOAT TOURNAMENT: SUPREME V4 EVALUATION ===")
    ...
    for name, model, path in models_to_test:
        ...
        results.append({
            ...
            "Status": "GOAT" if tactical_acc > 95 and correlation > 0.85 else "Tuning Needed"
        })
